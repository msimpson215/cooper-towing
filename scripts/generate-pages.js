...
const nav = (active) => `<header class="site-header">
  <div class="header-inner">
    <a href="/" class="logo" aria-label="Home">
      <svg class="logo-mark" viewBox="0 0 48 48" aria-hidden="true"><path d="M24 4 L40 42 H8 Z" fill="#ffc400"/><path d="M24 12 L34 38 H14 Z" fill="#c41e24"/></svg>
...
const pages = [
  ...
  { folder: "towing", file: "flatbed.html", active: "towing", title: "Flatbed Towing", h1: "Flatbed Towing", lead: "All four wheels off the ground — the safe choice for many vehicles.", body: `<p>Our flatbed trucks protect your vehicle during transport. Ideal for all-wheel drive, classics, and damage-sensitive loads.</p><p>Schedule or request emergency flatbed service: <a href="tel:6186718770" class="phone-inline">618-671-8770</a></p>` },
